<?php
namespace IrisWPTheme\SiteLeadsThemeKit;



use IrisWPTheme\SiteLeadsThemeKit\Customizer\Sections\SiteLeadsSection;
use IrisWPTheme\SiteLeadsThemeKit\Customizer\Controls\SiteLeadsIntegrationButton;
...
//        );
    ...
    public function enqueue_admin_scripts() {
        ...
        wp_add_inline_script(
            'jquery',
            sprintf(
                'window.iriswpthemeSiteLeadsData = %s;',
    ...
    public static function printSiteLeadsRecommendationPlugins() {
        ?>
          <div class="iriswptheme-siteleads-recommendation-plugins-tooltip__container">
              <span><?php echo esc_html(__('plugins', 'iris-wp')) ?></span>
              <div class="iriswptheme-siteleads-recommendation-plugins-tooltip">
                    <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="iriswptheme-siteleads-recommendation-plugins-tooltip__content">
                            <div class="iriswptheme-siteleads-recommendation-plugins-tooltip__item">
                                <div class="iriswptheme-siteleads-recommendation-plugins-tooltip__item__title">
                                    <?php echo esc_html(__('Kubio Page Builder (free)', 'iris-wp'));?>
                                </div>
                                <div class="iriswptheme-siteleads-recommendation-plugins-tooltip__item__description">
                                    <?php echo esc_html(sprintf(__('Adds drag and drop functionality and many other features to the %s theme.', 'iris-wp'),  static::get_current_theme_name()));?>
                                </div>
                            </div>

                            <div class="iriswptheme-siteleads-recommendation-plugins-tooltip__item">
                                <div class="iriswptheme-siteleads-recommendation-plugins-tooltip__item__title">
                                    <?php echo esc_html(__('SiteLeads (free)', 'iris-wp'))?>
                                </div>
                                <div class="iriswptheme-siteleads-recommendation-plugins-tooltip__item__description">
                                    <?php echo esc_html(__('Get more leads from your site by adding popular contact channels: Whatsapp, Messenger, Phone, AI Assistant, etc.', 'iris-wp'))?>
                                </div>
                            </div>
    ...
    public static function getEnableAllThemeFeatureDescriptionText() {
        ...
        esc_html_e(
            sprintf(
                __('To enable all theme features, please Install the %s recommended', 'iris-wp'),
    ...
    public static function getInstallCompanioNoticeDescriptionInCustomizerWithSiteLeadsCheck() {
        if(  SiteLeads::show_install_siteleads_recommendation()) {
            ob_start();
            ?>
            <div class="iriswptheme-install-plugin-description iriswptheme-siteleads-recommendation-plugins-tooltip__wrapper--customizer-install-notice">
    ...
    public static function getInstallCompanioNoticeDescriptionInWPAdminWithSiteLeadsCheck() {
        if(  SiteLeads::show_install_siteleads_recommendation()) {
            ob_start();
            ?>
            <div class="iriswptheme-siteleads-recommendation-plugins-tooltip__wrapper--customizer-install-notice description large-text">
                <?php
                esc_html_e(
                    sprintf(
                        __( 'This action will install the %s recommended', 'iris-wp' ),
                        SiteLeads::get_current_theme_name()
                    )
                );
                SiteLeads::printSiteLeadsRecommendationPlugins();
    ...
    public static function getInstallCompanionButtonLabelWithSiteLeadsCheck() {
        if(  SiteLeads::show_install_siteleads_recommendation() ) {
            return esc_html(__( 'Enable all theme features', 'iris-wp' ));
        } else {
            return esc_html(__( 'Install Kubio Page Builder', 'iris-wp' ));
        }
    }
    ...
    public static function getActivateCompanionButtonLabelWithSiteLeadsCheck() {
        if(  SiteLeads::show_install_siteleads_recommendation() ) {
            ...
            return esc_html(__( 'Activate Kubio Page Builder', 'iris-wp' ));
        }
    }
    public function print_call_icon_no_site_leads() {
        ...
        ?>
        <div class="iriswptheme-siteleads-for-theme-root --iriswptheme-siteleads-for-theme-root-alignment-right">
            <div class="iriswptheme-siteleads-for-theme-root-inner">
                <div class="iriswptheme-siteleads-for-theme-fc-widgets siteleads-fc-widgets">
                    <div class="iriswptheme-siteleads-for-theme-widget --iriswptheme-siteleads-for-theme-root-alignment-right --sl-simple-view --medium-size --has-attention-effect" style="--sl-full-fab-size: calc(var(--sl-base-fab-size) + 0px * 2 );--sl-fab-border-width: 0px; --sl-shadow-3:0px 3px 3px -2px rgba(0, 0, 0, 0.15), 0px 3px 4px 0px rgba(0, 0, 0, 0.105), 0px 1px 8px 0px rgba(0, 0, 0, 0.09)" data-widget-id="widget-1770032923949" data-view="simple" data-device="desktop" data-has-agent="false" data-single-channel="true">
                        <div class="iriswptheme-siteleads-for-theme-widget__channels" style="grid-template-columns: 1fr;--desktop-widget-color: #029900;box-shadow: var(--sl-shadow-3);border-radius:100%">
                            <div class="iriswptheme-siteleads-for-theme-channel__wrapper" style="color: red; --sl-icon-color: #029900; transition-duration: 0s; opacity: 1;">
                                <a class="iriswptheme-siteleads-for-theme-channel iriswptheme-siteleads-for-theme-channel__phone" rel="nofollow noopener" href="<?php echo esc_attr( $phone_link ); ?>" <?php echo esc_attr($extra_link_attributes); ?> data-channel="phone" style="color: #029900;border-radius: 100%;background-color: #029900;box-shadow: var(--sl-shadow-3);border-width: 0px;--sl-fab-border-width: 0px;border-color: #2363EB">
									<span class="iriswptheme-siteleads-for-theme-channel__icon" style="color: #029900;background: var(--sl-icon-color, transparent);border-radius: 100%;box-shadow: var(--sl-shadow-3)">
    ...
    public function ajax_siteleads_plugin_toggle_enabled() {
        ...
        if ( ! current_user_can( 'edit_theme_options' ) ) {
            wp_send_json_error( __( 'Not allowed', 'iris-wp' ), 400 );
        }
        if ( ! $this->get_site_leads_plugin_is_active() ) {
            wp_send_json_error( __( 'Required plugin is missing', 'iris-wp' ), 400 );
        }
        if ( ! class_exists( '\SiteLeads\Features\Widgets\FCWidgetsManager' ) ||
            ...
            wp_send_json_error(__('Required class or functions are missing', 'iris-wp'), 400);
        }


        if ( ! isset( $_POST['enabled'] ) ) {
            wp_send_json_error( __( 'Missing required parameter: enabled', 'iris-wp' ), 400 );
        }
        if ( ! isset( $_POST['widget_id'] ) ) {
            wp_send_json_error( __( 'Missing required parameter: widget_id', 'iris-wp' ), 400 );
        }
        // Sanitize the input
        ...
        if ( empty( $widget_id ) || !is_string($widget_id)) {
            ...
            if(empty( $widget_id ) || !is_string($widget_id)) {
                wp_send_json_error( __( 'Missing widget id', 'iris-wp' ), 400 );
            }
    ...
    public function add_customizer_controls_and_settings( $wp_customize ) {
        ...
        $wp_customize->add_section(
            new SiteLeadsSection(
                ...
                array(
                    'title'    => __( 'Contact Settings', 'iris-wp' ),
                    'priority' => 9999,
                )
            )
        );
        ...
        $wp_customize->add_control(
            Theme::prefix( 'show_contact_phone' ),
            array(
                'label'    => __( 'Show Contact Widget', 'iris-wp' ),
                'section'  => Theme::prefix( 'contact_settings' ),
                'type'     => 'checkbox',
                'priority' => 9,
    ...
    public function get_js_text_translations() {
        return array(
            'notice_title_not_installed'             => __( 'For more contact channels & settings, please install the', 'iris-wp' ),
            'notice_title_installed'             => __( 'For more contact channels & settings, please activate the', 'iris-wp' ),
            'notice_title_active'             => __( 'Contact channels & settings can be found inside the', 'iris-wp' ),

            'plugin_text'                      => __( 'plugin', 'iris-wp' ),



            'notice_description_1'             => __( 'SiteLeads adds popular contact channels to your site:', 'iris-wp' ),
            'notice_description_2'             => __( 'Whatsapp, Messenger, Phone, Email, AI Assistant, etc.', 'iris-wp' ),
            'notice_description_3'             => __( 'Visitors can easily reach you and you never miss a lead.', 'iris-wp' ),

            'info_notice_installing'            => __('Installing SiteLeads', 'iris-wp'),
            'info_notice_activating'            => __('Activating SiteLeads', 'iris-wp'),
            'info_notice_init'                  => __('Preparing SiteLeads', 'iris-wp'),


            'install_button_text_active_plugin'     => __( 'Manage Contact Widget', 'iris-wp' ),
            'install_button_text_installed_plugin'  => __( 'Activate SiteLeads', 'iris-wp' ),
            'install_button_not_installed_plugin'   => __( 'Install SiteLeads', 'iris-wp' ),

            'error_could_not_init_plugin_data'      => __( 'Could not initialise the SiteLeads plugin data', 'iris-wp' ),
            'error_could_not_install_plugin'        => __( 'Could not install the SiteLeads plugin', 'iris-wp' ),
            'error_could_not_activate_plugin'       => __( 'Could not activate the SiteLeads plugin', 'iris-wp' ),
            'error_could_not_toggle_plugin_enabled' => __( 'Could not toggle Siteleads plugin status', 'iris-wp' )
        );
    }
