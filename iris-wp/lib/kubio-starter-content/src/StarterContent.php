						...
						wp_json_encode(
							array(
								...
								'texts'        => array(
									...
									'message'              => Translations::get( 'customize_preview_overlay_message', 'iris-wp' ),
									'install'              => Translations::get( 'installing', 'iris-wp' ),
									'activate'             => Translations::get( 'activating', 'iris-wp' ),
								),
